...
In the future, we also plan to implement full restart policy support and automatic task restarts based on the configured policy. This will improve reliability and fault tolerance by allowing tasks to recover automatically after failures, crashes, or unexpected shutdowns.